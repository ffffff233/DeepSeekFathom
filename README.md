...
**[DeepSeekFathom-0.1.11-Setup.exe](https://github.com/ffffff233/DeepSeekFathom/releases/download/desktop-v0.1.11/DeepSeekFathom-0.1.11-Setup.exe)**
...
Outputs: `dist\DeepSeekFathom\DeepSeekFathom.exe` and, when Inno Setup 6 is installed, `dist\installer\DeepSeekFathom-0.1.11-Setup.exe`. The installer installs per user and creates branded **DeepSeekFathom** desktop and Start menu entries. Desktop releases use independent `desktop-vX.Y.Z` tags; GitHub Actions builds the installer from those tags and attaches it to the matching Release.
