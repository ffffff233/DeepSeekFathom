...
class ThinkingMode:
    ...
    def resolve(cls, mode: str) -> "ThinkingMode":
        modes = {
            "auto": cls("auto", "deepseek-v4-flash", 384000, "Let the model choose the thinking depth for each prompt.", 0, True, "high"),
            ...
            "fast": cls("fast", "deepseek-v4-flash", 384000, "Use quick reasoning and prefer cheap exploratory tool calls.", 0, True, "high"),
            "standard": cls("standard", "deepseek-v4-flash", 384000, "Use normal task reasoning with concise checks.", 0, True, "high"),
            "balanced": cls("balanced", "deepseek-v4-pro", 384000, "Use measured reasoning. Plan briefly before risky edits.", 1, True, "high"),
            ...
            "deeper": cls("deeper", "deepseek-v4-pro", 384000, "Use deeper multi-step reasoning for complex debugging and architecture.", 2, True, "max"),
